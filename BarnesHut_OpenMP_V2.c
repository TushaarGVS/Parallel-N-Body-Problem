/* 
 * gcc BarnesHut_OpenMP.c -o barnes_openmp -lm -fopenmp
 * ./barnes_openmp filename number_of_threads
 */
#include <stdio.h>
#include <stdlib.h>
#include <malloc.h>
...
#pragma omp parallel for num_threads(NUMTHREADS) private(subQuadrant)
...
int main(int argc, char *argv[]) {
  ...
  printf("Total time for parallel Barnes Hut in OpenMP: %lf\n", treeConstructionTime + forceCalculationTime) ;
